...
#  setopt localoptions pipefail no_aliases 2> /dev/null
#  local file="$(eval "$cmd" | FZF_DEFAULT_OPTS="--height ${FZF_TMUX_HEIGHT:-40%} --reverse $FZF_DEFAULT_OPTS $FZF_ALT_E_OPTS" $(__fzfcmd) +m)"
#  if [[ -z "$file" ]]; then
#    zle redisplay
#    return 0
#  fi
